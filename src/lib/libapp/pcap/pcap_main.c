...
BS_STATUS PCAP_Main_RegService
(
    IN UINT uiIndex,
...
BS_STATUS PCAP_Main_SendPkt(IN UINT uiIndex, IN MBUF_S *pstMbuf)
{
    BS_STATUS eRet;
...
BS_STATUS PCAP_Main_Ioctl(IN UINT uiIndex, IN UINT uiCmd, INOUT VOID *pData)
{
