...
static BPFASM_FUNC_S g_bpfasm_progs[] = { 
    {.func_name="MYBPF_PROG_ReplaceMapFdWithMapPtr", .insn_offset=0}, 
    {0} }; 

static MYBPF_INSN_S g_bpfasm_insts[] = { 
    /* MYBPF_PROG_ReplaceMapFdWithMapPtr */
...
{ 
    U64 bpf_ret; 
    int ret = BPFASM_Run(&g_bpfasm_ctrl, "MYBPF_PROG_ReplaceMapFdWithMapPtr", &bpf_ret, p1, p2, p3, p4, p5); 
    if (ret < 0) return ret; 
    return bpf_ret; 
} 
