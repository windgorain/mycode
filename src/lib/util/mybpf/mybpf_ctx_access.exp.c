...
static MYBPF_INSN_S g_bpfasm_insts[] = { 
    ...
    BPF_JMP_REG(BPF_JSGT, BPF_R5, BPF_R1, 12), 
    ...
    BPF_JMP_REG(BPF_JGT, BPF_R4, BPF_R7, 16), 
    BPF_JMP_IMM(BPF_JEQ, BPF_R7, 4, 3), 
    BPF_JMP_IMM(BPF_JEQ, BPF_R7, 7, 2), 
    ...
    BPF_ALU64_IMM(BPF_AND, BPF_R9, 15), 
    BPF_ALU64_IMM(BPF_LSH, BPF_R9, 4), 
    BPF_MOV64_REG(BPF_R3, BPF_R10), 
    BPF_ALU64_IMM(BPF_ADD, BPF_R3, -176), 
    BPF_ALU64_REG(BPF_ADD, BPF_R3, BPF_R9), 
    BPF_STX_MEM(BPF_W, BPF_R3, BPF_R8, 0), 
    BPF_ALU64_IMM(BPF_AND, BPF_R7, 240), 
    BPF_MOV64_REG(BPF_R3, BPF_R10), 
    BPF_ALU64_IMM(BPF_ADD, BPF_R3, -176), 
    BPF_ALU64_REG(BPF_ADD, BPF_R3, BPF_R7), 
    BPF_LDX_MEM(BPF_W, BPF_R3, BPF_R3, 0), 
    BPF_MOV64_REG(BPF_R7, BPF_R6), 
    BPF_JMP_IMM(BPF_JNE, BPF_R3, 2, 51), 
    BPF_MOV64_REG(BPF_R3, BPF_R6), 
    BPF_ALU64_IMM(BPF_ADD, BPF_R3, -97), 
    BPF_MOV64_REG(BPF_R8, BPF_R3), 
    BPF_ALU64_IMM(BPF_LSH, BPF_R8, 7), 
    BPF_ALU64_IMM(BPF_AND, BPF_R3, 254), 
    BPF_ALU64_IMM(BPF_RSH, BPF_R3, 1), 
    BPF_ALU64_REG(BPF_OR, BPF_R8, BPF_R3), 
    BPF_ALU64_IMM(BPF_AND, BPF_R8, 255), 
    BPF_MOV64_REG(BPF_R7, BPF_R6), 
    BPF_JMP_IMM(BPF_JGT, BPF_R8, 13, 41), 
    BPF_MOV64_IMM(BPF_R3, 1), 
    BPF_ALU64_REG(BPF_LSH, BPF_R3, BPF_R8), 
    BPF_ALU64_IMM(BPF_AND, BPF_R3, 13107), 
    BPF_MOV64_REG(BPF_R7, BPF_R6), 
    BPF_JMP_IMM(BPF_JNE, BPF_R3, 0, 1), 
    BPF_JMP_A(35), 
    BPF_LDX_MEM(BPF_H, BPF_R3, BPF_R2, 2), 
    ...
    BPF_ALU64_IMM(BPF_AND, BPF_R3, 1073741823), 
    BPF_ALU64_REG(BPF_OR, BPF_R8, BPF_R3), 
    ...
    BPF_MOV64_REG(BPF_R7, BPF_R6), 
    BPF_JMP_IMM(BPF_JNE, BPF_R8, 2, 11), 
    ...
    BPF_JMP_IMM(BPF_JEQ, BPF_R7, 24, -100), 
