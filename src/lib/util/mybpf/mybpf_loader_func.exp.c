...
static MYBPF_INSN_S g_bpfasm_insts[] = { 
    ...
    BPF_LDX_MEM(BPF_W, BPF_R1, BPF_R2, 120), 
    BPF_ALU64_IMM(BPF_RSH, BPF_R1, 16), 
    BPF_STX_MEM(BPF_B, BPF_R6, BPF_R1, 122), 
    BPF_LDX_MEM(BPF_W, BPF_R1, BPF_R2, 124), 
    BPF_STX_MEM(BPF_W, BPF_R6, BPF_R1, 124), 
    BPF_ALU64_IMM(BPF_ADD, BPF_R2, 128), 
    BPF_MOV64_REG(BPF_R7, BPF_R6), 
    BPF_ALU64_IMM(BPF_ADD, BPF_R7, 128), 
    BPF_MOV64_REG(BPF_R1, BPF_R7), 
    BPF_MOV64_IMM(BPF_R3, 256), 
    BPF_RAW_INSN(BPF_JMP | BPF_CALL, 0, 0, 0, 1000040), 
    BPF_LDX_MEM(BPF_W, BPF_R1, BPF_R6, 120), 
    ...
    BPF_LDX_MEM(BPF_W, BPF_R2, BPF_R6, 120), 
    ...
    BPF_LDX_MEM(BPF_W, BPF_R1, BPF_R9, 904), 
    ...
    BPF_STX_MEM(BPF_DW, BPF_R1, BPF_R7, 648), 
    BPF_LDX_MEM(BPF_W, BPF_R1, BPF_R9, 120), 
    BPF_ALU64_IMM(BPF_ADD, BPF_R1, 256), 
    BPF_ALU64_IMM(BPF_RSH, BPF_R1, 8), 
    BPF_STX_MEM(BPF_B, BPF_R9, BPF_R1, 121), 
    ...
    BPF_EXIT_INSN(), 
    BPF_LDX_MEM(BPF_DW, BPF_R7, BPF_R9, 920), 
    ...
    BPF_LDX_MEM(BPF_W, BPF_R8, BPF_R9, 120), 
    ...
    BPF_LDX_MEM(BPF_DW, BPF_R9, BPF_R9, 936), 
    ...
    BPF_LDX_MEM(BPF_W, BPF_R4, BPF_R3, 120), 
    ...
    BPF_LDX_MEM(BPF_W, BPF_R5, BPF_R3, 124), 
    ...
    BPF_ALU64_IMM(BPF_ADD, BPF_R3, 128), 
    ...
    BPF_STX_MEM(BPF_DW, BPF_R6, BPF_R0, 928), 
    ...
    BPF_ALU64_IMM(BPF_ADD, BPF_R1, 944), 
    BPF_STX_MEM(BPF_DW, BPF_R0, BPF_R1, 0), 
    BPF_MOV64_REG(BPF_R1, BPF_R0), 
    BPF_ALU64_IMM(BPF_ADD, BPF_R1, 8), 
    BPF_STX_MEM(BPF_DW, BPF_R6, BPF_R1, 936), 
    BPF_LDX_MEM(BPF_W, BPF_R1, BPF_R6, 120), 
    BPF_ALU64_IMM(BPF_OR, BPF_R1, 1), 
    BPF_STX_MEM(BPF_W, BPF_R6, BPF_R1, 120), 
    BPF_LDX_MEM(BPF_W, BPF_R2, BPF_R6, 912), 
    BPF_ALU64_IMM(BPF_ADD, BPF_R2, 8), 
    BPF_STX_MEM(BPF_W, BPF_R6, BPF_R2, 908), 
    BPF_MOV64_REG(BPF_R1, BPF_R0), 
