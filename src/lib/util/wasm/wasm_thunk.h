...
*
================================================================*/
#ifndef _WASM_THUNK_H
#define _WASM_THUNK_H
#ifdef __cplusplus
extern "C"
{
#endif
...
#define TH_WA_i WASM_I32
#define TH_WA_I WASM_I64
#define TH_WA_f WASM_F32
#define TH_WA_F WASM_F64
...
#define THUNK_IN_FN_0(M,R) \
    TH_C_##R thunk_in_##R##_0() { \
        ...
        wasm_interpret(M); return TH_IN_RET_##R(M); \
    }
