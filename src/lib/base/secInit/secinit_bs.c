...
static _SEC_INIT_CTRL_S g_stBsInitTable[] =  
{
    ...
    _SEC_INIT_ELEMENT (SSHOW_Init,   SECINIT_STAGE_INIT0, SECINIT_ORDER_LAST),
    ...
    _SEC_INIT_ELEMENT (RcuBs_Init,   SECINIT_STAGE_INIT1, SECINIT_ORDER_NORMAL),
