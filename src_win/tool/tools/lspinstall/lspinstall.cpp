...
GUID  ProviderGuid = {0xd3c21122, 0x85e1, 0x48f3,  
                            {0x9a,0xb6,0x23,0xd9,0x0c,0x76,0x87,0xee}}; 
...
{ 
    ...
    memcpy(&LayeredProtocolInfo, &OriginalProtocolInfo[1], sizeof(WSAPROTOCOL_INFOW)); 
...
int main(int argc, char *argv[])
{
    ...
    { 
        ...
        { 
            ...
            if(::GetFullPathName(L"sslvpnlsp.dll", 256, szPathName, &p) != 0) 
            { 
    ...
    printf(" Usage: lspinstall [ -install │ -remove ] \n"); 
